...
def go(args):
    ...
    # Only include values between correct range
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        help="name of artifact inputted",## INSERT DESCRIPTION HERE,
        required=True
    )
    ...
    parser.add_argument(
        "--output_artifact", 
        type=str,## INSERT TYPE HERE: str, float or int,
        help="name of artifact created",## INSERT DESCRIPTION HERE,
        required=True
    )
    ...
    parser.add_argument(
        "--output_description", 
        type=str,## INSERT TYPE HERE: str, float or int,
        help="description of the result",## INSERT DESCRIPTION HERE,
        required=True
    )
